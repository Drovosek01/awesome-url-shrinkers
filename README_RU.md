# Сервисы по укорачиванию ссылок

## Содержание

- [Сервисы по укорачиванию ссылок](#сервисы-по-укорачиванию-ссылок)
  - [Содержание](#содержание)
  - [Что это за репозиторий](#что-это-за-репозиторий)
  - [Списки сервисов](#списки-сервисов)
    - [Рабочие сервисы](#рабочие-сервисы)
      - [Специальные](#специальные)
      - [Earn money](#earn-money)
    - [Работа сервиса приостановлена](#работа-сервиса-приостановлена)
    - [Проверить с VPN](#проверить-с-vpn)
    - [Мертвые сервисы](#мертвые-сервисы)
    - [Выглядят нерабочими](#выглядят-нерабочими)
    - [Стали приватными](#стали-приватными)
    - [Другие списки](#другие-списки)

## Что это за репозиторий

Этот репозиторий - это список сервисов для укорачивания длинной ссылки в короткую путем перенаправления перехода с короткой ссылки на длинную. В общем сервисы, которые перенаправляют переходы по ссылкам.
...
В данном случае под работоспособностью имеется ввиду, что сайт открывается (открываются в России) и на главной странице нет уведомления о том, что работа сервиса приостановлена.
...
Позволяют сократить ссылку только для ссылок с определенных сервисов
...
На главной странице сервисов указано, что они сделаны для зарабатывания денег. То есть такие сервисы не будут выполнять моментальное перенаправление, а будут показывать рекламу в ходе перенаправления.
...
На главной странице находится уведомление о том, что работа сервиса приостановлена на неизвестный период.
...
Страницы этих сайтов не открылись в России. Возможно эти сервисы просто не работают в России из-за выполнения санкций против России, а возможно эти сервисы просто умерли. Необходимо проверить открытие этих сайтов вместе с включенным VPN.
...
Сервисы прекратили работу или работают но уже ни как сервисы для укорачивания ссылок.
...
Сайт работает но функция укорачивания ссылки временно или постоянно не работает.
